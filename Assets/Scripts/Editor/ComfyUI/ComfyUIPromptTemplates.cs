...
namespace ComfyUI
{
    ...
    public static class ComfyUIPromptTemplates
    {
        ...
        // 基础风格词（所有资产类型共用）
        // ==========================================
        public const string BaseStylePrompt =
            "(dark fantasy art:1.3), (hand-drawn style:1.2), (2D top-down game sprite:1.4), " +
            "gothic fantasy, dark atmospheric, painterly texture, visible brushstrokes, " +
            "(soul glow: blue-purple luminescence #4A3A8C), (crystal erosion: geometric cyan crystals #00D4FF), " +
            "dark moody lighting, rim light, high contrast";
        ...
        public static string GetFullPositivePrompt(string assetType)
        {
            ...
            {
                return $"{BaseStylePrompt}, {template.positivePrompt}";
            }
