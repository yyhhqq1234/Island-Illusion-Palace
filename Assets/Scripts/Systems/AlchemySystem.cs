    ...
    public MaterialData GetMaterialData(MaterialTypeEnum type)
    {
        switch (type)
        {
            ...
            case MaterialTypeEnum.StarlightGrass:
                return new MaterialData(MaterialTypeEnum.StarlightGrass, "星光草", 3, "夜晚发光的植物。", "常见", "草原、森林地图采集");
            ...
            case MaterialTypeEnum.MoonlightFlower:
                return new MaterialData(MaterialTypeEnum.MoonlightFlower, "月影花", 5, "满月夜绽放的银色花朵。", "常见", "月光下的森林、草原采集");
            ...
            case MaterialTypeEnum.CloudyDew:
                return new MaterialData(MaterialTypeEnum.CloudyDew, "浑浊露珠", 8, "凝结时空能量的水珠。", "常见", "森林、草原、雪山地清晨采集");
            case MaterialTypeEnum.PurifyingSalt:
                return new MaterialData(MaterialTypeEnum.PurifyingSalt, "净化盐晶", 9, "蕴含净化能量的盐结晶。", "常见", "岩地、沙漠地图采集");
            case MaterialTypeEnum.WailingVine:
                return new MaterialData(MaterialTypeEnum.WailingVine, "哀嚎藤蔓", 10, "触碰时会发出悲鸣的黑暗植物。", "常见", "沼泽、湿地地图采集");
            
            // 稀有材料
            case MaterialTypeEnum.MemoryResidue:
                return new MaterialData(MaterialTypeEnum.MemoryResidue, "记忆残渣", 11, "记忆逸散的能量渣滓。", "稀有", "记忆碎片区域采集");
            ...
            case MaterialTypeEnum.SoulCrystal:
                return new MaterialData(MaterialTypeEnum.SoulCrystal, "灵魂结晶", 13, "提纯凝固的灵魂能量块。", "稀有", "灵魂吞噬者、精英怨魂掉落");
            ...
            case MaterialTypeEnum.FrostShard:
                return new MaterialData(MaterialTypeEnum.FrostShard, "极寒冰屑", 19, "永恒冻土中形成的刺骨冰屑。", "稀有", "雪山地采集，冰原狼掉落");
            case MaterialTypeEnum.AncientDragonBonePowder:
                return new MaterialData(MaterialTypeEnum.AncientDragonBonePowder, "古龙骨粉", 20, "研磨自远古巨兽骨骼的能量粉末。", "稀有", "岩地、雪山地远古遗骸处采集");
